...
const reducer = createReducer(initialState,
  ...
  on(A.loadAllPeople, A.loadAllPeopleError, state => R.set(R.lensPath(['loading', 'people']), true, state)),
  ...
  on(A.loadAllStarships, A.loadAllStarshipError, (state) => R.set(R.lensPath(['loading', 'starships']), true, state)),
